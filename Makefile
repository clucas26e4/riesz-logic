...
completeness.vo : completeness.v Rpos.vo term.vo hseq.vo semantic.vo interpretation.vo tactics.vo $(OLLIBSDIR)/Permutation_more.vo $(OLLIBSDIR)/Permutation_solve.vo  $(OLLIBSDIR)/List_more.vo
...
main_results.vo : main_results.v semantic_Rsemantic_eq.vo Rsemantic.vo semantic.vo hseq.vo completeness.vo soundness.vo Rterm.vo term.vo Rpos.vo interpretation.vo

tactics.vo : tactics.v hseq.vo Rpos.vo term.vo $(OLLIBSDIR)/Permutation_more.vo $(OLLIBSDIR)/Permutation_solve.vo
